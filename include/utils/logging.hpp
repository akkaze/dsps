#ifndef DSPS_LOGGING_HPP
#define DSPS_LOGGING_HPP
#include <cstdio>
#include <cstdlib>
#include <cmath>
#include <string>
...
#define DFATAL ERROR
#define DLOG(severity) true ? (void)0 : mlite::LogMessageVoidify() & LOG(severity)
#define DLOG_IF(severity, condition) \
(true || !(condition)) ? (void)0 : mlite::LogMessageVoidify() & LOG(severity)
#else
